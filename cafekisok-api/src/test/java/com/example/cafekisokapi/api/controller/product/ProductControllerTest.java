package com.example.cafekisokapi.api.controller.product;

import com.example.cafekisokapi.product.controller.ProductController;
...
class ProductControllerTest {
    ...
    @Test
    void createProductWithZeroBase() throws Exception {
        // given
        ProductCreateRequest request = ProductCreateRequest.builder()
                .type(HANDMADE)
                .sellingStatus(SELLING)
